package com.unical.solarVision.config;

import com.unical.solarVision.repository.UserRepository;
import com.unical.solarVision.security.AuthorizationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                ...
                .antMatchers("api/detection*","api//detection/*","/login","/v2/api-docs", "/configuration/**", "/swagger-resources/**",  "/swagger-ui.html", "/webjars/**", "/api-docs/**").permitAll()
